...
*/
	...
	Com_Error( ERR_DROP, "Bad cgame system trap: %" INT64PRINTF, (int64_t)args[0] );
	return 0;
}
...
void CL_InitCGame( void ) {
	...
	cgvm = VM_Create( "cgame", (qboolean)!!(com_basePathLibraries->integer & 2), CL_CgameSystemCalls, interpret );
	if ( !cgvm ) {
