...
{
	// thanks to https://github.com/DogeProtocol/hybrid-pqc
#if WIN32_USE_BCRYPT
	NTSTATUS    Status;
	...
	Status = BCryptGenRandom(
		...
		(PUCHAR)buf,						// Address of the buffer that recieves the random number(s)
	...
	//Fallback if BCryptGenRandom failed or not available
	HCRYPTPROV ctx;
	BOOL tmp;
	DWORD to_read = 0;
