...
void		CM_BoxTrace ( trace_t *results, const vec3_t start, const vec3_t end,
						  ...
						  clipHandle_t model, int brushmask, qboolean capsule, traceCustomization_t* traceCustomization, int* shaderNum = NULL);
void		CM_TransformedBoxTrace( trace_t *results, const vec3_t start, const vec3_t end,
						  const vec3_t mins, const vec3_t maxs,
						  clipHandle_t model, int brushmask,
						  const vec3_t origin, const vec3_t angles, qboolean capsule, traceCustomization_t* traceCustomization, int* shaderNum = NULL);
