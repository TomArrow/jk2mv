...
//	Swap_Init ();
	...
	cool_apiFeatures = Cvar_Get("cool_apiFeatures", va("%d",COOL_APIFEATURE_SETPREDICTEDMOVEMENT|COOL_APIFEATURE_GETTEMPORARYUSERCMD|COOL_APIFEATURE_EXPANDEDSETUSERCMD), CVAR_INIT | CVAR_VM_NOWRITE);
