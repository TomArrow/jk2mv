...
*/
	...
	CG_COOL_API_SETPREDICTEDMOVEMENT = 1100,
	CG_COOL_API_SETUSERCMDMOVE = 1101,
	CG_COOL_API_SET_EZDEMO_BUFFER = 1102,
	...
	CG_COOL_API_DB_ADDREQUEST = 1201,
	CG_COOL_API_DB_NEXTRESPONSE = 1202,
	CG_COOL_API_DB_GETREFERENCE = 1203,
	CG_COOL_API_DB_NEXTROW = 1204,
	CG_COOL_API_DB_GETINT = 1205,
	CG_COOL_API_DB_GETFLOAT = 1206,
	CG_COOL_API_DB_GETSTRING = 1207,
	CG_COOL_API_DB_ADDREQUEST_TYPED = 1208,

	CG_COOL_API_DB_ADDPREPAREDSTATEMENT = 1209,
	CG_COOL_API_DB_PREPAREDBINDSTRING = 1210,
	CG_COOL_API_DB_PREPAREDBINDFLOAT = 1211,
	CG_COOL_API_DB_PREPAREDBINDINT = 1212,
	CG_COOL_API_DB_PREPAREDBINDBINARY = 1213,
	CG_COOL_API_DB_FINISHANDSENDPREPAREDSTATEMENT = 1214,
	CG_COOL_API_DB_GETBINARY = 1215,
	CG_COOL_API_DB_PREPAREDBINDNULL = 1216,
	...
	CG_COOL_API_CREATE_FILE_LIST              = 2008,
	CG_COOL_API_CLOSE_FILE_LIST               = 2009,
	CG_COOL_API_READ_FROM_FILE_LIST           = 2010,
	CG_COOL_API_ALLOCATE_MEMORY               = 2011,
	CG_COOL_API_REALLOCATE_MEMORY             = 2012,
	CG_COOL_API_FREE_MEMORY                   = 2013,
	CG_COOL_API_WRITE_MEMORY                  = 2014,
	CG_COOL_API_READ_MEMORY                   = 2015,
	CG_COOL_API_GET_ELEMENT_SIZE_FROM_MEMORY  = 2016,
	CG_COOL_API_CLEAR_MEMORY                  = 2017,
} cgameImport_t;
