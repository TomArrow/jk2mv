...
code
proc FX_RepeaterProjectileThink 0 0
endproc FX_RepeaterProjectileThink 0 0
export FX_RepeaterHitWall
proc FX_RepeaterHitWall 0 0
endproc FX_RepeaterHitWall 0 0
export FX_RepeaterHitPlayer
proc FX_RepeaterHitPlayer 0 0
endproc FX_RepeaterHitPlayer 0 0
export FX_RepeaterAltProjectileThink
proc FX_RepeaterAltProjectileThink 0 0
endproc FX_RepeaterAltProjectileThink 0 0
export FX_RepeaterAltHitWall
proc FX_RepeaterAltHitWall 0 0
endproc FX_RepeaterAltHitWall 0 0
export FX_RepeaterAltHitPlayer
proc FX_RepeaterAltHitPlayer 0 0
endproc FX_RepeaterAltHitPlayer 0 0
