...
code
proc FX_BryarProjectileThink 0 0
endproc FX_BryarProjectileThink 0 0
export FX_BryarHitWall
proc FX_BryarHitWall 0 0
endproc FX_BryarHitWall 0 0
export FX_BryarHitPlayer
proc FX_BryarHitPlayer 0 0
endproc FX_BryarHitPlayer 0 0
export FX_BryarAltProjectileThink
proc FX_BryarAltProjectileThink 0 0
endproc FX_BryarAltProjectileThink 0 0
export FX_BryarAltHitWall
proc FX_BryarAltHitWall 0 0
endproc FX_BryarAltHitWall 0 0
export FX_BryarAltHitPlayer
proc FX_BryarAltHitPlayer 0 0
endproc FX_BryarAltHitPlayer 0 0
export FX_TurretProjectileThink
proc FX_TurretProjectileThink 0 0
endproc FX_TurretProjectileThink 0 0
export FX_TurretHitWall
proc FX_TurretHitWall 0 0
endproc FX_TurretHitWall 0 0
export FX_TurretHitPlayer
proc FX_TurretHitPlayer 0 0
endproc FX_TurretHitPlayer 0 0
