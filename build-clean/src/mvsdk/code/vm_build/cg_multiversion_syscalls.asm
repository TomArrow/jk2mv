...
code
proc trap_Key_IsDown 0 0
endproc trap_Key_IsDown 0 0
export trap_Key_GetKey
proc trap_Key_GetKey 0 0
endproc trap_Key_GetKey 0 0
import trap_Key_GetKey_real
import trap_Key_IsDown_real
