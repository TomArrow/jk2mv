...
byte 4 1137770496
code
proc PM_UpdateAntiLoop 0 0
endproc PM_UpdateAntiLoop 0 0
export PM_BGEntForNum
proc PM_BGEntForNum 0 0
endproc PM_BGEntForNum 0 0
export PM_GrabWallForJump
proc PM_GrabWallForJump 0 0
endproc PM_GrabWallForJump 0 0
data
...
proc PM_DoSlowFall 0 0
endproc PM_DoSlowFall 0 0
export PM_AddEvent
proc PM_AddEvent 0 0
endproc PM_AddEvent 0 0
export PM_AddEventWithParm
proc PM_AddEventWithParm 0 0
endproc PM_AddEventWithParm 0 0
export PM_AddTouchEnt
proc PM_AddTouchEnt 0 0
endproc PM_AddTouchEnt 0 0
export PM_ClipVelocityQ2
proc PM_ClipVelocityQ2 0 0
endproc PM_ClipVelocityQ2 0 0
export PM_ClipVelocity
proc PM_ClipVelocity 0 0
endproc PM_ClipVelocity 0 0
proc PM_Friction 0 0
endproc PM_Friction 0 0
proc PM_Accelerate 0 0
endproc PM_Accelerate 0 0
proc PM_SickoAccelerate 0 0
endproc PM_SickoAccelerate 0 0
proc PM_QuaJKAccelerate 0 0
endproc PM_QuaJKAccelerate 0 0
lit
align 4
LABELV $307
byte 4 1084227584
code
proc PM_DreamAccelerate 0 0
endproc PM_DreamAccelerate 0 0
proc PM_CmdScale 0 0
endproc PM_CmdScale 0 0
proc PM_SetMovementDir 0 0
endproc PM_SetMovementDir 0 0
export PM_ForceJumpingUp
proc PM_ForceJumpingUp 0 0
endproc PM_ForceJumpingUp 0 0
export PM_JumpForDir
proc PM_JumpForDir 0 0
endproc PM_JumpForDir 0 0
export PM_SetPMViewAngle
proc PM_SetPMViewAngle 0 0
endproc PM_SetPMViewAngle 0 0
export PM_AdjustAngleForWallRun
proc PM_AdjustAngleForWallRun 0 0
endproc PM_AdjustAngleForWallRun 0 0
proc BG_ForceWallJumpStrength 0 0
endproc BG_ForceWallJumpStrength 0 0
export PM_AdjustAngleForWallJump
proc PM_AdjustAngleForWallJump 0 0
endproc PM_AdjustAngleForWallJump 0 0
export PM_SetForceJumpZStart
proc PM_SetForceJumpZStart 0 0
endproc PM_SetForceJumpZStart 0 0
export PM_SetGroundEntityNum
proc PM_SetGroundEntityNum 0 0
endproc PM_SetGroundEntityNum 0 0
proc PM_CheckJump 0 0
endproc PM_CheckJump 0 0
proc PM_CheckWaterJump 0 0
endproc PM_CheckWaterJump 0 0
export PM_ForcePowerAvailable
proc PM_ForcePowerAvailable 0 0
endproc PM_ForcePowerAvailable 0 0
export PM_ForcePowerUsable
proc PM_ForcePowerUsable 0 0
endproc PM_ForcePowerUsable 0 0
export PM_ForceJumpCharge
proc PM_ForceJumpCharge 0 0
endproc PM_ForceJumpCharge 0 0
lit
align 4
LABELV $1022
byte 4 1116564446
...
code
proc PM_GetVelocityForForceJump 0 0
endproc PM_GetVelocityForForceJump 0 0
export PM_ChargeForceJump
proc PM_ChargeForceJump 0 0
endproc PM_ChargeForceJump 0 0
proc PM_CheckChargeJump 0 0
endproc PM_CheckChargeJump 0 0
proc PM_WaterJumpMove 0 0
endproc PM_WaterJumpMove 0 0
proc PM_WaterMove 0 0
endproc PM_WaterMove 0 0
proc PM_FlyMove 0 0
endproc PM_FlyMove 0 0
proc PM_AirMove 0 0
endproc PM_AirMove 0 0
proc PM_WalkMove 0 0
endproc PM_WalkMove 0 0
proc PM_DeadMove 0 0
endproc PM_DeadMove 0 0
proc PM_NoclipMove 0 0
endproc PM_NoclipMove 0 0
proc PM_FootstepForSurface 0 0
endproc PM_FootstepForSurface 0 0
proc PM_TryRoll 0 0
endproc PM_TryRoll 0 0
proc PM_CrashLand 0 0
endproc PM_CrashLand 0 0
proc PM_CorrectAllSolid 0 0
endproc PM_CorrectAllSolid 0 0
proc PM_GroundTraceMissed 0 0
endproc PM_GroundTraceMissed 0 0
proc PM_GroundTrace 0 0
endproc PM_GroundTrace 0 0
proc PM_SetWaterLevel 0 0
endproc PM_SetWaterLevel 0 0
proc PM_CheckDuck 0 0
endproc PM_CheckDuck 0 0
export PM_Use
proc PM_Use 0 0
endproc PM_Use 0 0
export PM_RunningAnim
proc PM_RunningAnim 0 0
endproc PM_RunningAnim 0 0
proc PM_Footsteps 0 0
endproc PM_Footsteps 0 0
proc PM_WaterEvents 0 0
endproc PM_WaterEvents 0 0
export PM_BeginWeaponChange
proc PM_BeginWeaponChange 0 0
endproc PM_BeginWeaponChange 0 0
export PM_FinishWeaponChange
proc PM_FinishWeaponChange 0 0
endproc PM_FinishWeaponChange 0 0
proc PM_DoChargedWeapons 0 0
endproc PM_DoChargedWeapons 0 0
export PM_ItemUsable
proc PM_ItemUsable 0 0
endproc PM_ItemUsable 0 0
proc PM_Weapon 0 0
endproc PM_Weapon 0 0
proc PM_Animate 0 0
endproc PM_Animate 0 0
proc PM_DropTimers 0 0
endproc PM_DropTimers 0 0
export PM_UpdateViewAngles
proc PM_UpdateViewAngles 0 0
endproc PM_UpdateViewAngles 0 0
export PM_AdjustAttackStates
proc PM_AdjustAttackStates 0 0
endproc PM_AdjustAttackStates 0 0
export BG_CmdForRoll
proc BG_CmdForRoll 0 0
endproc BG_CmdForRoll 0 0
export BG_AdjustClientSpeed
proc BG_AdjustClientSpeed 0 0
endproc BG_AdjustClientSpeed 0 0
export PM_CheckRollEnd
proc PM_CheckRollEnd 0 0
endproc PM_CheckRollEnd 0 0
proc PM_SetAnimAfterQ2 0 0
endproc PM_SetAnimAfterQ2 0 0
export PM_SetModData
proc PM_SetModData 0 0
endproc PM_SetModData 0 0
lit
align 4
LABELV $2678
byte 4 0
...
export PmoveSingle
code
proc PmoveSingle 0 0
endproc PmoveSingle 0 0
export Pmove
proc Pmove 0 0
endproc Pmove 0 0
import fpclassify
