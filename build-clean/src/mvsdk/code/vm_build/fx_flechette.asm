...
code
proc FX_FlechetteProjectileThink 0 0
endproc FX_FlechetteProjectileThink 0 0
export FX_FlechetteWeaponHitWall
proc FX_FlechetteWeaponHitWall 0 0
endproc FX_FlechetteWeaponHitWall 0 0
export FX_FlechetteWeaponHitPlayer
proc FX_FlechetteWeaponHitPlayer 0 0
endproc FX_FlechetteWeaponHitPlayer 0 0
export FX_FlechetteAltProjectileThink
proc FX_FlechetteAltProjectileThink 0 0
endproc FX_FlechetteAltProjectileThink 0 0
