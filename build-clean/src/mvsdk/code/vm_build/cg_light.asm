...
code
proc CG_ClearLightStyles 0 0
endproc CG_ClearLightStyles 0 0
export CG_RunLightStyles
proc CG_RunLightStyles 0 0
endproc CG_RunLightStyles 0 0
export CG_SetLightstyle
proc CG_SetLightstyle 0 0
endproc CG_SetLightstyle 0 0
bss
align 4
LABELV lastofs
skip 4
