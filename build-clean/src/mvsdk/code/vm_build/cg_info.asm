...
code
proc CG_LoadingString 0 0
endproc CG_LoadingString 0 0
export CG_LoadingItem
proc CG_LoadingItem 0 0
endproc CG_LoadingItem 0 0
export CG_LoadingClient
proc CG_LoadingClient 0 0
endproc CG_LoadingClient 0 0
export CG_DrawInformation
proc CG_DrawInformation 0 0
endproc CG_DrawInformation 0 0
export CG_LoadBar
proc CG_LoadBar 0 0
endproc CG_LoadBar 0 0
