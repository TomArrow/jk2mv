export BG_SoundIndex
code
proc BG_SoundIndex 0 0
endproc BG_SoundIndex 0 0
data
export FPTable
align 4
LABELV FPTable
...
address $179
byte 4 -1
export SaberMoveTable
align 4
LABELV SaberMoveTable
address $192
byte 4 0
address $193
byte 4 4
...
address $179
byte 4 -1
export BG_ParseLiteral
code
proc BG_ParseLiteral 0 0
endproc BG_ParseLiteral 0 0
export TranslateSaberColor
proc TranslateSaberColor 0 0
endproc TranslateSaberColor 0 0
export TranslateSaberStyle
proc TranslateSaberStyle 0 0
endproc TranslateSaberStyle 0 0
export WP_SaberBladeUseSecondBladeStyle
proc WP_SaberBladeUseSecondBladeStyle 0 0
endproc WP_SaberBladeUseSecondBladeStyle 0 0
export WP_SaberBladeDoTransitionDamage
proc WP_SaberBladeDoTransitionDamage 0 0
endproc WP_SaberBladeDoTransitionDamage 0 0
export WP_UseFirstValidSaberStyle
proc WP_UseFirstValidSaberStyle 0 0
endproc WP_UseFirstValidSaberStyle 0 0
export WP_SaberStyleValidForSaber
proc WP_SaberStyleValidForSaber 0 0
endproc WP_SaberStyleValidForSaber 0 0
export WP_SaberCanTurnOffSomeBlades
proc WP_SaberCanTurnOffSomeBlades 0 0
endproc WP_SaberCanTurnOffSomeBlades 0 0
export WP_SaberSetDefaults
proc WP_SaberSetDefaults 0 0
endproc WP_SaberSetDefaults 0 0
export WP_SaberParseParms
proc WP_SaberParseParms 0 0
endproc WP_SaberParseParms 0 0
export WP_SaberParseParm
proc WP_SaberParseParm 0 0
endproc WP_SaberParseParm 0 0
lit
align 1
LABELV $1239
byte 1 0
skip 7
export WP_SaberValidForPlayerInMP
code
proc WP_SaberValidForPlayerInMP 0 0
endproc WP_SaberValidForPlayerInMP 0 0
export WP_RemoveSaber
proc WP_RemoveSaber 0 0
endproc WP_RemoveSaber 0 0
export WP_SetSaber
proc WP_SetSaber 0 0
endproc WP_SetSaber 0 0
export WP_SaberSetColor
proc WP_SaberSetColor 0 0
endproc WP_SaberSetColor 0 0
export WP_SaberLoadParms
proc WP_SaberLoadParms 0 0
endproc WP_SaberLoadParms 0 0
export BG_BLADE_ActivateTrail
proc BG_BLADE_ActivateTrail 0 0
endproc BG_BLADE_ActivateTrail 0 0
export BG_BLADE_DeactivateTrail
proc BG_BLADE_DeactivateTrail 0 0
endproc BG_BLADE_DeactivateTrail 0 0
export BG_SI_Activate
proc BG_SI_Activate 0 0
endproc BG_SI_Activate 0 0
export BG_SI_Deactivate
proc BG_SI_Deactivate 0 0
endproc BG_SI_Deactivate 0 0
export BG_SI_BladeActivate
proc BG_SI_BladeActivate 0 0
endproc BG_SI_BladeActivate 0 0
export BG_SI_Active
proc BG_SI_Active 0 0
endproc BG_SI_Active 0 0
export BG_SI_SetLength
proc BG_SI_SetLength 0 0
endproc BG_SI_SetLength 0 0
export BG_SI_SetDesiredLength
proc BG_SI_SetDesiredLength 0 0
endproc BG_SI_SetDesiredLength 0 0
export BG_SI_SetLengthGradual
proc BG_SI_SetLengthGradual 0 0
endproc BG_SI_SetLengthGradual 0 0
export BG_SI_Length
proc BG_SI_Length 0 0
endproc BG_SI_Length 0 0
export BG_SI_LengthMax
proc BG_SI_LengthMax 0 0
endproc BG_SI_LengthMax 0 0
export BG_SI_ActivateTrail
proc BG_SI_ActivateTrail 0 0
endproc BG_SI_ActivateTrail 0 0
export BG_SI_DeactivateTrail
proc BG_SI_DeactivateTrail 0 0
endproc BG_SI_DeactivateTrail 0 0
bss
align 1
LABELV bgSaberParseTBuffer
skip 524288
align 1
LABELV SaberParms
skip 524288
