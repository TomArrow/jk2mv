...
code
proc FX_DisruptorMainShot 0 0
endproc FX_DisruptorMainShot 0 0
lit
align 4
LABELV $163
byte 4 1061997773
...
code
proc FX_DisruptorAltShot 0 0
endproc FX_DisruptorAltShot 0 0
export FX_DisruptorAltMiss
proc FX_DisruptorAltMiss 0 0
endproc FX_DisruptorAltMiss 0 0
export FX_DisruptorAltHit
proc FX_DisruptorAltHit 0 0
endproc FX_DisruptorAltHit 0 0
export FX_DisruptorHitWall
proc FX_DisruptorHitWall 0 0
endproc FX_DisruptorHitWall 0 0
export FX_DisruptorHitPlayer
proc FX_DisruptorHitPlayer 0 0
endproc FX_DisruptorHitPlayer 0 0
