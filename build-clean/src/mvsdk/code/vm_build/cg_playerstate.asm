...
proc CG_DamageFeedback 0 0
endproc CG_DamageFeedback 0 0
export CG_Respawn
proc CG_Respawn 0 0
endproc CG_Respawn 0 0
export CG_CheckPlayerstateEvents
proc CG_CheckPlayerstateEvents 0 0
endproc CG_CheckPlayerstateEvents 0 0
export CG_CheckChangedPredictableEvents
proc CG_CheckChangedPredictableEvents 0 0
endproc CG_CheckChangedPredictableEvents 0 0
proc pushReward 0 0
endproc pushReward 0 0
proc CG_ResetRewards 0 0
endproc CG_ResetRewards 0 0
data
...
code
proc CG_CheckLocalSounds 0 0
endproc CG_CheckLocalSounds 0 0
export CG_TransitionPlayerState
proc CG_TransitionPlayerState 0 0
endproc CG_TransitionPlayerState 0 0
import eventnames
