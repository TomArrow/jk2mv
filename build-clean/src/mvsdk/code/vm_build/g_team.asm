...
line 1146
;1145:
;1146:		for (i = 0; i < g_maxclients.integer; i++) {
ADDRLP4 4
CNSTI4 0
ASGNI4
ADDRGP4 $651
...
;1160:/*-----------------------------------------------------------------*/
;1161:
;1162:/*QUAKED team_CTF_redplayer (1 0 0) (-16 -16 -16) (16 16 32)
;1163:Only in CTF games.  Red players spawn here at game start.
;1164:*/
;1165:void SP_team_CTF_redplayer( gentity_t *ent ) {
line 1166
;1166:}
LABELV $658
...
;1167:
;1168:
;1169:/*QUAKED team_CTF_blueplayer (0 0 1) (-16 -16 -16) (16 16 32)
;1170:Only in CTF games.  Blue players spawn here at game start.
;1171:*/
;1172:void SP_team_CTF_blueplayer( gentity_t *ent ) {
line 1173
;1173:}
LABELV $659
...
;1174:
;1175:
;1176:/*QUAKED team_CTF_redspawn (1 0 0) (-16 -16 -24) (16 16 32)
;1177:potential spawning position for red team in CTF games.
;1178:Targets will be fired when someone spawns in on them.
;1179:*/
;1180:void SP_team_CTF_redspawn(gentity_t *ent) {
line 1181
;1181:}
LABELV $660
...
line 1187
;1182:
;1183:/*QUAKED team_CTF_bluespawn (0 0 1) (-16 -16 -24) (16 16 32)
;1184:potential spawning position for blue team in CTF games.
;1185:Targets will be fired when someone spawns in on them.
;1186:*/
;1187:void SP_team_CTF_bluespawn(gentity_t *ent) {
line 1188
;1188:}
LABELV $661
