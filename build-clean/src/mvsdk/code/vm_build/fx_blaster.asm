...
code
proc FX_BlasterProjectileThink 0 0
endproc FX_BlasterProjectileThink 0 0
export FX_BlasterAltFireThink
proc FX_BlasterAltFireThink 0 0
endproc FX_BlasterAltFireThink 0 0
export FX_BlasterWeaponHitWall
proc FX_BlasterWeaponHitWall 0 0
endproc FX_BlasterWeaponHitWall 0 0
export FX_BlasterWeaponHitPlayer
proc FX_BlasterWeaponHitPlayer 0 0
endproc FX_BlasterWeaponHitPlayer 0 0
