...
code
proc FX_DEMP2_ProjectileThink 0 0
endproc FX_DEMP2_ProjectileThink 0 0
export FX_DEMP2_HitWall
proc FX_DEMP2_HitWall 0 0
endproc FX_DEMP2_HitWall 0 0
export FX_DEMP2_HitPlayer
proc FX_DEMP2_HitPlayer 0 0
endproc FX_DEMP2_HitPlayer 0 0
export FX_DEMP2_AltBeam
proc FX_DEMP2_AltBeam 0 0
endproc FX_DEMP2_AltBeam 0 0
export FX_DEMP2_AltDetonate
proc FX_DEMP2_AltDetonate 0 0
endproc FX_DEMP2_AltDetonate 0 0
