...
code
proc CGSagaGetValueGroup 0 0
endproc CGSagaGetValueGroup 0 0
export CGSagaGetPairedValue
proc CGSagaGetPairedValue 0 0
endproc CGSagaGetPairedValue 0 0
export CG_InitSagaMode
proc CG_InitSagaMode 0 0
endproc CG_InitSagaMode 0 0
export CG_SagaRoundOver
proc CG_SagaRoundOver 0 0
endproc CG_SagaRoundOver 0 0
export CG_SagaObjectiveCompleted
proc CG_SagaObjectiveCompleted 0 0
endproc CG_SagaObjectiveCompleted 0 0
bss
